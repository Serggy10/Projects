...
#define NUM_LEDS 150  // Número de LEDs en la tira
...
float filterbrightness(float input) {
  ...
  // Define los factores de suavizado
  float smoothingFactorUp = 0.8;      // Suavizado rápido para subidas
  float smoothingFactorDown = 0.1;    // Suavizado lento para bajadas
